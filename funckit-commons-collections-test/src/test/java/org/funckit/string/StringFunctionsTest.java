...
public class StringFunctionsTest {
	...
	public void filterAndTransform() {
		...
		@SuppressWarnings("unchecked") // API of commons collections v3 is not parameterized. 
		Object[] actuals = CollectionUtils.collect(strings, length).toArray(new Object[0]);
